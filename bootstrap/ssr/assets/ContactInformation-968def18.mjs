...
function ContactInformation() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("h2", { className: "text-lg font-medium text-slate-900", children: "Detail Pembeli" }),
    /* @__PURE__ */ jsxs("div", { className: "relative mt-4 rounded-lg bg-white p-4 shadow", children: [
      /* @__PURE__ */ jsx(
        Link,
        {
