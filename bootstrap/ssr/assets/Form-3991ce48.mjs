    ...
    children: imagePreview
      ? /* @__PURE__ */ jsxs(Fragment, {
          children: [
            ...
            (errors == null ? void 0 : errors.picture) &&
              /* @__PURE__ */ jsx("div", {
                className: "mb-5",
...
function Form({ categories, product, page_settings }) {
  ...
  const [inputFields, setInputFields] = useState(
    product.variations &&
      ((_a = product.variations) == null ? void 0 : _a.length) > 0
      ? product.variations
      : [
          {
            attribute_1: "",
  ...
  return /* @__PURE__ */ jsxs("div", {
    children: [
      /* @__PURE__ */ jsx(Head, { title: "Tambah Produk" }),
...
Form.layout = (page) =>
  /* @__PURE__ */ jsx(AppLayout, {
    header: /* @__PURE__ */ jsx("h2", {
      ...
      children: page.props.page_settings.title,
    }),
    children: page,
  });
