...
function k(t, e, i, n = "brackets") {
  let o = /^https?:\/\//.test(e.toString()), c = o || e.toString().startsWith("/"), h = !c && !e.toString().startsWith("#") && !e.toString().startsWith("?"), m = e.toString().includes("?") || t === "get" && Object.keys(i).length, b = e.toString().includes("#"), a = new URL(e.toString(), "http://localhost");
  return t === "get" && Object.keys(i).length && (a.search = O.stringify((0, import_deepmerge.default)(O.parse(a.search, { ignoreQueryPrefix: true }), i), { encodeValuesOnly: true, arrayFormat: n }), i = {}), [[o ? `${a.protocol}//${a.host}` : "", c ? a.pathname : "", h ? a.pathname.substring(1) : "", m ? a.search : "", b ? a.hash : ""].join(""), i];
}
function w(t) {
...
var C = class {
  ...
  visit(e, { method: i = "get", data: n = {}, replace: o = false, preserveScroll: c = false, preserveState: h = false, only: m = [], headers: b = {}, errorBag: a = "", forceFormData: l = false, onCancelToken: g = () => {
  }, onBefore: L = () => {
  }, onStart: d = () => {
  }, onProgress: p = () => {
  }, onFinish: T = () => {
    ...
    let P = { url: x, method: i, data: n, replace: o, preserveScroll: c, preserveState: h, only: m, headers: b, errorBag: a, forceFormData: l, queryStringArrayFormat: F, cancelled: false, completed: false, interrupted: false };
    if (L(P) === false || !M(P))
      return;
    this.activeVisit && this.cancelVisit(this.activeVisit, { interrupted: true }), this.saveScrollPositions();
    let G2 = this.createVisitId();
    this.activeVisit = { ...P, onCancelToken: g, onBefore: L, onStart: d, onProgress: p, onFinish: T, onCancel: y, onSuccess: D2, onError: U2, queryStringArrayFormat: F, cancelToken: new AbortController() }, g({ cancel: () => {
      this.activeVisit && this.cancelVisit(this.activeVisit, { cancelled: true });
    } }), W(P), d(P), axios_default({ method: i, url: w(x).href, data: i === "get" ? {} : n, params: i === "get" ? n : {}, signal: this.activeVisit.cancelToken.signal, headers: { ...b, Accept: "text/html, application/xhtml+xml", "X-Requested-With": "XMLHttpRequest", "X-Inertia": true, ...m.length ? { "X-Inertia-Partial-Component": this.page.component, "X-Inertia-Partial-Data": m.join(",") } : {}, ...a && a.length ? { "X-Inertia-Error-Bag": a } : {}, ...this.page.version ? { "X-Inertia-Version": this.page.version } : {} }, onUploadProgress: (r) => {
...
async function U({ id: l = "app", resolve: c, setup: s, title: p, progress: a = {}, page: S2, render: d }) {
...
var j2 = (0, import_react6.forwardRef)(({ children: l, as: c = "a", data: s = {}, href: p, method: a = "get", preserveScroll: S2 = false, preserveState: d = null, replace: P = false, only: u2 = [], headers: g = {}, queryStringArrayFormat: f2 = "brackets", onClick: e = k2, onCancelToken: i = k2, onBefore: r = k2, onStart: y = k2, onProgress: T = k2, onFinish: H2 = k2, onCancel: F = k2, onSuccess: L = k2, onError: b = k2, ...O2 }, x) => {
  let I2 = (0, import_react6.useCallback)((o) => {
    e(o), ee(o) && (o.preventDefault(), Oe.visit(p, { data: s, method: a, preserveScroll: S2, preserveState: d ?? a !== "get", replace: P, only: u2, headers: g, onCancelToken: i, onBefore: r, onStart: y, onProgress: T, onFinish: H2, onCancel: F, onSuccess: L, onError: b }));
  }, [s, p, a, S2, d, P, u2, g, e, i, r, y, T, H2, F, L, b]);
  c = c.toLowerCase(), a = a.toLowerCase();
  let [h, t] = k(a, p || "", s, f2);
  return p = h, s = t, c === "a" && a !== "get" && console.warn(`Creating POST/PUT/PATCH/DELETE <a> links is discouraged as it causes "Open Link in New Tab/Window" accessibility issues.

Please specify a more appropriate element using the "as" attribute. For example:

<Link href="${p}" method="${a}" as="button">...</Link>`), (0, import_react6.createElement)(c, { ...O2, ...c === "a" ? { href: p } : {}, ref: x, onClick: I2 }, l);
});
...
function W2(l, c) {
  let s = (0, import_react7.useRef)(null), p = typeof l == "string" ? l : null, [a, S2] = (0, import_react7.useState)((typeof l == "string" ? c : l) || {}), d = (0, import_react7.useRef)(null), P = (0, import_react7.useRef)(null), [u2, g] = p ? w2(a, `${p}:data`) : (0, import_react7.useState)(a), [f2, e] = p ? w2({}, `${p}:errors`) : (0, import_react7.useState)({}), [i, r] = (0, import_react7.useState)(false), [y, T] = (0, import_react7.useState)(false), [H2, F] = (0, import_react7.useState)(null), [L, b] = (0, import_react7.useState)(false), [O2, x] = (0, import_react7.useState)(false), I2 = (t) => t;
  (0, import_react7.useEffect)(() => (s.current = true, () => {
    s.current = false;
  }), []);
  let h = (0, import_react7.useCallback)((t, o, n = {}) => {
    let C2 = { ...n, onCancelToken: (m) => {
      if (d.current = m, n.onCancelToken)
        return n.onCancelToken(m);
    }, onBefore: (m) => {
      if (b(false), x(false), clearTimeout(P.current), n.onBefore)
        return n.onBefore(m);
    }, onStart: (m) => {
      if (T(true), n.onStart)
        return n.onStart(m);
      ...
      if (s.current && (T(false), F(null), e({}), r(false), b(true), x(true), P.current = setTimeout(() => {
        s.current && x(false);
      }, 2e3)), n.onSuccess)
        return n.onSuccess(m);
    }, onError: (m) => {
      if (s.current && (T(false), F(null), e(m), r(true)), n.onError)
        return n.onError(m);
    }, onCancel: () => {
      if (s.current && (T(false), F(null)), n.onCancel)
        return n.onCancel();
    }, onFinish: () => {
      if (s.current && (T(false), F(null)), d.current = null, n.onFinish)
        return n.onFinish();
    } };
  ...
  }, isDirty: !(0, import_lodash.default)(u2, a), errors: f2, hasErrors: i, processing: y, progress: H2, wasSuccessful: L, recentlySuccessful: O2, transform(t) {
    I2 = t;
  }, setDefaults(t, o) {
